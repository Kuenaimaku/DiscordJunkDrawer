...
{
    [Group("demo")]
    public class DemoModule : InteractiveBase<SocketCommandContext>
    {

        // DeleteAfterAsync will send a message and asynchronously delete it after the timeout has popped
        // This method will not block.
        [Command("delete")]
        public async Task<RuntimeResult> DemonstrateDeleteAfterAsync()
        {
        ...
        [Command("next")]
        public async Task DemonstrateNextMessageAsync()
        {
        ...
        [Command("pagination")]
        public async Task DemonstratePaginationAsync()
        {
            var pages = new[]
            {
        ...
        [Command("reaction")]
        public async Task DemonstrateInlineReactionReplyAsync()
        {
        ...
        public async Task DemonstrateEmbedReactionReplyAsync(bool expiresafteruse, bool singleuseperuser, bool sourceuser)
        {
